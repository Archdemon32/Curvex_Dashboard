        ...
        [
            ...
            dbc.Row([
                ...
                dbc.Col(html.Div(children=[
                    ...
                    'width':'160px', 'height':'40px','background-color':'#F2F2F2', 'color':'#262626'}),
                    html.Br()
                ]),
                    align='end',
...
def machine_learning():
    ...
    # Adding the new value together with the column name to the 
    # users personal excel file and predicts if the preson has adhd 
    k=model.predict(df1)
