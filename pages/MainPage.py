    ...
    [   
        ...
        dbc.Row([
            ...
            dbc.Row([    
                ...
                dbc.Col(html.Div(children=[
                    html.Br(),
                    html.A(html.Button('Submit', id='split-file', n_clicks=0,style={'font-size':'29px', 'width':'160px', 'height':'40px','background-color':'#F2F2F2', 'color':'#262626'}),href='/')
        ...
        dbc.Row([
            ...
            dbc.Col(html.Div(children=[            
                html.Br(),
                html.H3('Choose the value', className='text-center'),
                dcc.Dropdown(
                    id='Value-Selector',
